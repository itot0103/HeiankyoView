...
public class GlDefaultCanvas extends JPanel implements org.heiankyoview2.core.gldraw.Canvas {
	...
	public GlDefaultCanvas(
		...
		glc = new GLCanvas();
		drawer = new GlDefaultDrawer(width, height, glc);
	 ...
	 * @param height 画面の高さ
	 */
	public GlDefaultCanvas(int width, int height) {
	 ...
	 * @param d Drawer
	 */
	public void setDrawer(GlDefaultDrawer d) {
		drawer = d;
	}
