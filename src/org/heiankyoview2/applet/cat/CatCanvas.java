...
public class CatCanvas extends JPanel implements org.heiankyoview2.core.gldraw.Canvas {
	...
	public CatCanvas(
		...
		glc = new GLCanvas();
		drawer = new CatDrawer(width, height, glc);
	 ...
	 * @param height 画面の高さ
	 */
	public CatCanvas(int width, int height) {
	 ...
	 * @param d Drawer
	 */
	public void setDrawer(CatDrawer d) {
		drawer = d;
	}
	...
	/**
	 * カーソルを当てた画像の拡大モードのサポート
	 */
	public void setFatMode(boolean f) {
